...
ROLE_DEFINITIONS: dict[str, dict[str, Any]] = {
    ...
    "scouting_lead":        {"label": "Scouting Lead",        "level": "lead",   "subteam": "scouting",      "requires_approval": True,  "can_moderate": _MODERATE_ALL, "school_info": {"required": True},  "attendance": {"view": True},  "control_panel": {"view": True, "meeting_time": True, "meeting_agenda": True, "upcoming_event": True, "notifications": True}, "tasks": {"view": True, "assign": True}},
