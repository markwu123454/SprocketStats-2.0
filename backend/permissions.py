...
ROLE_DEFINITIONS: dict[str, dict[str, Any]] = {
    ...
    "cad_lead":             {"label": "CAD Lead",             "school_info": {"required": True},  "attendance": {"view": True},  "control_panel": {"view": True, "meeting_agenda": True, "notifications": True}},
    "manufacturing_member": {"label": "Manufacturing Member", "school_info": {"required": True},  "attendance": {"view": True},  "control_panel": {"view": False}},
    "manufacturing_lead":   {"label": "Manufacturing Lead",   "school_info": {"required": True},  "attendance": {"view": True},  "control_panel": {"view": True, "meeting_agenda": True, "notifications": True}},
    "programming_member":   {"label": "Programming Member",   "school_info": {"required": True},  "attendance": {"view": True},  "control_panel": {"view": False}},
    "programming_lead":     {"label": "Programming Lead",     "school_info": {"required": True},  "attendance": {"view": True},  "control_panel": {"view": True, "meeting_agenda": True, "notifications": True}},
    ...
    "scouting_lead":        {"label": "Scouting Lead",        "school_info": {"required": True},  "attendance": {"view": True},  "control_panel": {"view": True, "meeting_time": True, "meeting_agenda": True, "upcoming_event": True, "notifications": True}},
    "publicity_member":     {"label": "Publicity Member",     "school_info": {"required": True},  "attendance": {"view": True},  "control_panel": {"view": False}},
    "publicity_lead":       {"label": "Publicity Lead",       "school_info": {"required": True},  "attendance": {"view": True},  "control_panel": {"view": True, "meeting_agenda": True, "notifications": True}},
    "operations_member":    {"label": "Operations Member",    "school_info": {"required": True},  "attendance": {"view": True},  "control_panel": {"view": False}},
    "operations_lead":      {"label": "Operations Lead",      "school_info": {"required": True},  "attendance": {"view": True},  "control_panel": {"view": True, "meeting_agenda": True, "notifications": True}},
    "outreach_member":      {"label": "Outreach Member",      "school_info": {"required": True},  "attendance": {"view": True},  "control_panel": {"view": False}},
    "outreach_lead":        {"label": "Outreach Lead",        "school_info": {"required": True},  "attendance": {"view": True},  "control_panel": {"view": True, "meeting_agenda": True, "notifications": True}},
    "captain":              {"label": "Captain",              "school_info": {"required": True},  "attendance": {"view": True},  "control_panel": {"view": True, "meeting_time": True, "meeting_agenda": True, "upcoming_event": True, "members": True, "notifications": True}},
    "mentor":               {"label": "Mentor",               "school_info": {"required": False}, "attendance": {"view": False}, "control_panel": {"view": True, "meeting_time": True, "meeting_agenda": True, "upcoming_event": True, "members": True, "notifications": True}},
