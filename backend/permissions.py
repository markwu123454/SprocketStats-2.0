...
ROLE_DEFINITIONS: dict[str, dict[str, Any]] = {
    "cad_member":           {"label": "CAD Member",           "school_info": {"required": True},  "control_panel": {"view": False}},
    "cad_lead":             {"label": "CAD Lead",             "school_info": {"required": True},  "control_panel": {"view": True}},
    "manufacturing_member": {"label": "Manufacturing Member", "school_info": {"required": True},  "control_panel": {"view": False}},
    "manufacturing_lead":   {"label": "Manufacturing Lead",   "school_info": {"required": True},  "control_panel": {"view": True}},
    "programming_member":   {"label": "Programming Member",   "school_info": {"required": True},  "control_panel": {"view": False}},
    "programming_lead":     {"label": "Programming Lead",     "school_info": {"required": True},  "control_panel": {"view": True}},
    "scouting_member":      {"label": "Scouting Member",      "school_info": {"required": True},  "control_panel": {"view": False}},
    "scouting_lead":        {"label": "Scouting Lead",        "school_info": {"required": True},  "control_panel": {"view": True}},
    "publicity_member":     {"label": "Publicity Member",     "school_info": {"required": True},  "control_panel": {"view": False}},
    "publicity_lead":       {"label": "Publicity Lead",       "school_info": {"required": True},  "control_panel": {"view": True}},
    "operations_member":    {"label": "Operations Member",    "school_info": {"required": True},  "control_panel": {"view": False}},
    "operations_lead":      {"label": "Operations Lead",      "school_info": {"required": True},  "control_panel": {"view": True}},
    "outreach_member":      {"label": "Outreach Member",      "school_info": {"required": True},  "control_panel": {"view": False}},
    "outreach_lead":        {"label": "Outreach Lead",        "school_info": {"required": True},  "control_panel": {"view": True}},
    "captain":              {"label": "Captain",              "school_info": {"required": True},  "control_panel": {"view": True}},
    "mentor":               {"label": "Mentor",               "school_info": {"required": False}, "control_panel": {"view": True}},
    "alumni":               {"label": "Alumni",               "school_info": {"required": False}, "control_panel": {"view": False}},
}
